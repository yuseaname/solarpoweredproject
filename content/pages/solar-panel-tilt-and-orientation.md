+++
title = "Solar Panel Tilt Angle and Orientation: Maximize Output Year-Round"
slug = "solar-panel-tilt-and-orientation"
date = 2026-08-10
draft = false
description = "What angle should solar panels be tilted? Learn how latitude, azimuth, season, and roof pitch affect solar output — plus when tracking systems are worth it."
image = "/images/solar-panel-tilt-and-orientation/hero.webp"
image_alt = "Four solar panels on an angled metal ground-mount frame — the tilt and orientation this guide calculates"
...
| Tilt angle | Best season | Typical use case |
| :--- | :--- | :--- |
| 25° (flat-ish) | Summer | Grid-tied, maximizing annual kWh |
| 40° (latitude) | Year-round | Balanced production, most common |
| 55° (steep) | Winter | Off-grid winter reliance, snow shedding |
...
| Azimuth | Direction | Annual output vs. south-facing |
| :--- | :--- | :--- |
| 180° | South | 100% (baseline) |
| 225° | Southwest | ~95% |
| 270° | West | ~85–90% |
| 135° | Southeast | ~92% |
| 90° | East | ~80–85% |
...
If your roof faces the wrong direction or has the wrong pitch, a ground mount may be the better choice. See our <a href="ground-mount-vs-roof-mount-solar.html" class="text-link">ground mount vs roof mount solar</a> comparison.
...
| Season | Tilt setting | When to adjust |
| :--- | :--- | :--- |
| Spring / Fall | Latitude (e.g., 40°) | Around March 21 and September 21 |
| Summer | Latitude minus 15° (e.g., 25°) | Around June 21 |
| Winter | Latitude plus 15° (e.g., 55°) | Around December 21 |
...
| Mount type | Output vs. fixed | Cost vs. fixed | Best for |
| :--- | :--- | :--- | :--- |
| Fixed mount (optimal angle) | Baseline | Baseline | Almost all residential |
