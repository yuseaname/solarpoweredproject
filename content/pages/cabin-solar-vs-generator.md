...
<a href="cabin-solar-sizing.html" class="text-link">Cabin solar sizing (step-by-step)</a> <a href="solar-system-costs.html" class="text-link">Solar system costs (general)</a>
...
<tr class="odd">
<td>Upfront cost</td>
<td>Higher for off-grid systems</td>
<td>Lower to get started</td>
</tr>
<tr class="even">
<td>Ongoing cost</td>
<td>Low (maintenance and occasional replacements)</td>
...
<tr class="even">
<td>Reliability</td>
<td>Great in sunny seasons; limited by winter/cloud</td>
<td>Great if fuel is available</td>
</tr>
<tr class="odd">
<td>Maintenance</td>
<td>Low</td>
<td>Regular (oil, filters, storage)</td>
</tr>
</tbody>
</table>

<figure>
<img src="../assets/images/diesel-generator.jpg" loading="lazy" width="1400" height="1050" alt="Large diesel generator set used for off-grid backup power." />
<figcaption>Image: “Cumminspower” by Frobles, CC BY-SA 3.0 — Source: <a href="https://commons.wikimedia.org/wiki/File:Cumminspower.jpg" class="text-link">Wikimedia Commons</a></figcaption>
</figure>
...
<a href="cabin-solar-cost.html" class="text-link">Cabin solar cost breakdown</a> <a href="solar-maintenance.html" class="text-link">Solar maintenance checklist</a> <a href="solar-output-troubleshooting.html" class="text-link">Low solar output troubleshooting</a>
