...
<a href="#key-takeaways" class="text-link">Key takeaways</a> <a href="#real-world-rv-solar-builds-with-actual-costs" class="text-link">Real-world RV solar builds with actual costs</a> <a href="#diy-vs-professional-installation-cost" class="text-link">DIY vs professional installation cost</a> <a href="#cost-breakdown-by-category" class="text-link">Cost breakdown by category</a> <a href="#how-sizing-impacts-cost-and-prevents-overspending" class="text-link">How sizing impacts cost (and prevents overspending)</a> <a href="#where-rv-builds-typically-overspend" class="text-link">Where RV builds typically overspend</a> <a href="#what-size-rv-solar-do-i-need-quick-reference" class="text-link">What size RV solar do I need? (quick reference)</a>
## Key takeaways
...
For help matching your loads to system size, use the <a href="rv-solar-sizing.html" class="text-link">RV solar sizing guide</a> and <a href="solar-panel-output.html" class="text-link">solar panel output calculator</a>.
...
<tr class="odd">
<td>Solar panels</td>
<td>$0.50–$1.10 per watt</td>
<td>Roof space and mounting matter</td>
</tr>
<tr class="even">
<td>Battery</td>
<td>$200–$900 per kWh</td>
<td>Biggest driver for off-grid time</td>
</tr>
<tr class="odd">
<td>Charge controller</td>
<td>$120–$700</td>
<td>MPPT costs more but can improve harvest</td>
</tr>
<tr class="even">
<td>Inverter</td>
<td>$250–$1,500+</td>
<td>Sized to peak AC loads and surge</td>
</tr>
<tr class="odd">
<td>Wiring &amp; protection</td>
<td>$150–$900</td>
<td>Fuses, breakers, bus bars, connectors</td>
</tr>
<tr class="even">
<td>Mounting hardware</td>
<td>$100–$600</td>
<td>Brackets, sealant, cable glands</td>
</tr>
</tbody>
</table>

Related: <a href="solar-system-costs.html" class="text-link">Solar system cost breakdown (general)</a>
...
- **Wire (copper is expensive) ($50–$200):** 4 AWG or 2 AWG cable for battery-to-inverter runs adds up fast. Don't cheap out on undersized wire — it's a fire risk. See <a href="solar-wire-size.html" class="text-link">solar wire size guide</a>.
