...
2. LiTime 100Ah review (verify datasheet claims vs brand-comparison table first) — first-10 #1 in the [affiliate strategy](affiliate-product-strategy-2026-09-06.md).
3. Winter cluster by ~Oct 10 (first-10 #2–5): LiFePO4-charging-below-freezing (self-heating models verified: LiTime B0DJ957H39, Redodo B0F9YHLVJK), winterizing checklist, well-pump sizing (240V honesty), van-conversion use-case. **Time-sensitive** (pre-season window; cold-SERP already active).
4. Calculator upgrades (first-10 #6–7): fuse-size calculator on solar-fuse-and-breaker-sizing; cable-calc deepening + wire-size 100W example.
5. Remaining per [affiliate strategy](affiliate-product-strategy-2026-09-06.md) §7–8 (now the monetization plan of record) + [buyer-intent calendar](buyer-intent-content-plan-2026-09-05.md) weeks not yet shipped.
6. First monthly Rybbit funnel report — as soon as toggle is on + 30 days of data (AC-002/005).
